...
namespace SharedKit.SecurityComponent
{
	public class EncryptProvider
	{
        ...
        */
		...
		{
			BDSecurityChecker.Argument.IsNotEmpty(data, nameof(data));

			BDSecurityChecker.Argument.IsNotEmpty(key, nameof(key));
			BDSecurityChecker.Argument.IsEqualLength(key.Length, 32, nameof(key));

			BDSecurityChecker.Argument.IsNotEmpty(vector, nameof(vector));
			BDSecurityChecker.Argument.IsEqualLength(vector.Length, 16, nameof(vector));
		...
		public static string DESEncrypt(string data, string key)
		{
			BDSecurityChecker.Argument.IsNotEmpty(data, nameof(data));
			BDSecurityChecker.Argument.IsNotEmpty(key, nameof(key));
			BDSecurityChecker.Argument.IsEqualLength(key.Length, 24, nameof(key));
		...
		public static byte[] DESEncrypt(byte[] data, string key, string vector)
		{
			...
			BDSecurityChecker.Argument.IsEqualLength(key.Length, 24, nameof(key));
			BDSecurityChecker.Argument.IsNotEmpty(vector, nameof(vector));
			BDSecurityChecker.Argument.IsEqualLength(vector.Length, 8, nameof(vector));
		...
		{
			BDSecurityChecker.Argument.IsNotEmpty(pem, nameof(pem));
		...
		{
			BDSecurityChecker.Argument.IsNotEmpty(pkcsKey, nameof(pkcsKey));
		...
		{
			BDSecurityChecker.Argument.IsNotEmpty(content, nameof(content));
			BDSecurityChecker.Argument.IsNotEmpty(privateKey, nameof(privateKey));
			BDSecurityChecker.Argument.IsNotNull(rSASignaturePadding, nameof(rSASignaturePadding));
		...
		{
			BDSecurityChecker.Argument.IsNotEmpty(content, nameof(content));
			BDSecurityChecker.Argument.IsNotEmpty(signStr, nameof(signStr));
		...
		{
			BDSecurityChecker.Argument.IsNotEmpty(publicKey, nameof(publicKey));
			BDSecurityChecker.Argument.IsNotEmpty(srcString, nameof(srcString));
			BDSecurityChecker.Argument.IsNotNull(padding, nameof(padding));
		...
		{
			BDSecurityChecker.Argument.IsNotEmpty(publicKey, nameof(publicKey));
			BDSecurityChecker.Argument.IsNotNull(data, nameof(data));
			BDSecurityChecker.Argument.IsNotNull(padding, nameof(padding));
		...
		{
			BDSecurityChecker.Argument.IsNotEmpty(rsaKey, nameof(rsaKey));
			RSA rsa = RSA.Create();
		...
		{
			BDSecurityChecker.Argument.IsNotNull(rsa, nameof(rsa));
		...
		{
			BDSecurityChecker.Argument.IsNotEmpty(str, nameof(str));
		...
		{
			BDSecurityChecker.Argument.IsNotOutOfRange(length, 16, 48, nameof(length));
		...
		{
			BDSecurityChecker.Argument.IsNotOutOfRange(length, 48, 128, nameof(length));
			return CreateMachineKey(length);
		}
		...
		{
			BDSecurityChecker.Argument.IsNotEmpty(input, nameof(input));
