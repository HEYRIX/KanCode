...
namespace ProxySchedule
{
    ...
    public class NetHttpHelper
    {
        ...
        public static string HttpPostRequest(string url, string postData, out int status, string contentType = "application/x-www-form-urlencoded", bool isGBK = false)
        {
            ...
            try {
                ...
                if (!string.IsNullOrEmpty(postData)) {
                    ...
                    request.Method = "POST"; // System.Net.Http.HttpMethod.Post;
					byte[] bytes = null;
                    if (isGBK) {
